...
# Defaults
APPNAME="uptimekuma"
APPDIR="$HOME/.local/share/srv/docker/uptimekuma"
DATADIR="$HOME/.local/share/srv/docker/uptimekuma/files"
INSTDIR="$HOME/.local/share/dockermgr/uptimekuma"
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/uptimekuma"
REPORAW="$REPO/raw/$REPO_BRANCH"
APPVERSION="$(__appversion "$REPORAW/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# URL to container image [docker pull URL]
HUB_URL="louislam/uptime-kuma"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Directory variables
SERVER_DATA_DIR=""
SERVER_CONFIG_DIR=""
...
SERVER_PORT="${SERVER_PORT:-14015}"
SERVER_PORT_INT="${SERVER_PORT_INT:-3001}"
